...
- **Current Phase**: **Phase 00 - Foundation & Team Setup** (Done `[x]`)
- **Services Ready**: Mosquitto (MQTT), Neo4j (Graph DB), MinIO (Object Storage), and `replay-service` (Python base container).
